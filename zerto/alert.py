...
#            self.help_identifier, self.entity, self.level)
     def __str__(self):
        return ''turned_on={0}, help_identifier={1}, entity={2}, event_type={3}, description={4}'.format(
            self.turned_on, self.help_identifier, self.entity, self.level, self.description)
